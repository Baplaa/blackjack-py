...
# Ryan Chan: A01031389
# Sean Rice: A01295788
# Jesse Cardoso: A01263683
# Tristan Lingat: A01270360
...
def print_final_scores(playerHand: list, compHand: list, playerScore: int, compScore: int):
    """Counts how many cards are in Player's and Computer's Hand
...
def play_game():
    ...
    unlimitedMode: flag to set the game to unlimited cards
